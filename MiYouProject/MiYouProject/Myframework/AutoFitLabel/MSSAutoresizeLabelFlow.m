...
- (instancetype)initWithFrame:(CGRect)frame titles:(NSArray *)titles selectedHandler:(selectedHandler)handler {
    ...
    if (self) {
        self.backgroundColor = [UIColor colorWithhex16stringToColor:Main_grayBackgroundColor];
...
- (void)setup {
    ...
    //self.collection.backgroundColor = [UIColor colorWithhex16stringToColor:Main_grayBackgroundColor];
